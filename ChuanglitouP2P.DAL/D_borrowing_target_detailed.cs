...
{
	/// <summary>
	/// 数据访问类:borrowing_target_detailed
	/// </summary>
	public partial class D_borrowing_target_detailed
	{
		public D_borrowing_target_detailed()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("target_detailed_id", "hx_borrowing_target_detailed"); 
		}
		...
		public bool Delete(int target_detailed_id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from hx_borrowing_target_detailed ");
			strSql.Append(" where target_detailed_id=@target_detailed_id");
			SqlParameter[] parameters = {
					new SqlParameter("@target_detailed_id", SqlDbType.Int,4)
			};
		...
		public bool DeleteList(string target_detailed_idlist )
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from hx_borrowing_target_detailed ");
			strSql.Append(" where target_detailed_id in ("+target_detailed_idlist + ")  ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select target_detailed_id,borrower_registerid,targetid,item_details,borrower_circumstances,borrower_base_material,use_funds,independent_advice,guarantee_agency_views,risk_control_measures,createtime ");
			strSql.Append(" FROM hx_borrowing_target_detailed ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" target_detailed_id,borrower_registerid,targetid,item_details,borrower_circumstances,borrower_base_material,use_funds,independent_advice,guarantee_agency_views,risk_control_measures,createtime ");
			strSql.Append(" FROM hx_borrowing_target_detailed ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			{
				strSql.Append("order by T.target_detailed_id desc");
			}
			strSql.Append(")AS Row, T.*  from hx_borrowing_target_detailed T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "hx_borrowing_target_detailed";
			parameters[1].Value = "target_detailed_id";
