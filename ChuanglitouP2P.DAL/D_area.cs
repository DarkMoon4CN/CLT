...
using ChuanglitouP2P.Model;//Please add references
namespace ChuanglitouP2P.DAL
{
	/// <summary>
	/// 数据访问类:area
	/// </summary>
	public partial class D_area
	{
		public D_area()
		{}
		#region  BasicMethod
		...
		/// 增加一条数据
		/// </summary>
		public int Add(M_area model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into area(");
			strSql.Append("areaID,area,fatherID)");
			strSql.Append(" values (");
			strSql.Append("@areaID,@area,@fatherID)");
			strSql.Append(";select @@IDENTITY");
			SqlParameter[] parameters = {
					new SqlParameter("@areaID", SqlDbType.Int,4),
					new SqlParameter("@area", SqlDbType.VarChar,200),
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(M_area model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public M_area GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,areaID,area,fatherID from area ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public M_area DataRowToModel(DataRow row)
		{
			M_area model=new M_area();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,areaID,area,fatherID ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,areaID,area,fatherID ");
			strSql.Append(" FROM area ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
