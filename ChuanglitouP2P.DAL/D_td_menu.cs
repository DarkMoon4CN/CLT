...
namespace ChuanglitouP2P.DAL
{
	...
	/// 数据访问类:td_menu
	/// </summary>
	public partial class D_td_menu
	{
		public D_td_menu()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("menu_id", "hx_td_menu"); 
		}
		...
		public bool Exists(int menu_id)
		{
			...
			strSql.Append("select count(1) from hx_td_menu");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into hx_td_menu(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update hx_td_menu set ");
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@menu_id", SqlDbType.Int,4)};
            parameters[0].Value = model.menu_name;           
            parameters[1].Value = model.path1;
            parameters[2].Value = model.path2;
            parameters[3].Value = model.path3;
            parameters[4].Value = model.path4;
		...
		public bool Delete(int menu_id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from hx_td_menu ");
			strSql.Append(" where menu_id=@menu_id");
			SqlParameter[] parameters = {
					new SqlParameter("@menu_id", SqlDbType.Int,4)
			};
		...
		public M_td_menu GetModel(int menu_id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 menu_id,menu_name,parentid,parentpath,depath,rootid,child,previd,nextid,orderid,createtime,path1,path2,path3,path4 from hx_td_menu ");
			strSql.Append(" where menu_id=@menu_id");
			SqlParameter[] parameters = {
					new SqlParameter("@menu_id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public M_td_menu DataRowToModel(DataRow row)
		{
			M_td_menu model=new M_td_menu();
			if (row != null)
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from hx_td_menu T ");
