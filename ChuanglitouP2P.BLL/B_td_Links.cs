...
namespace ChuanglitouP2P.BLL
{
	...
	/// td_Links
	/// </summary>
	public partial class B_td_Links
	{
		private readonly D_td_Links dal=new D_td_Links();
        public B_td_Links()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public M_td_Links GetModelByCache(int Linkid)
		{
			
			string CacheKey = "td_LinksModel-" + Linkid;
		...
		/// 获得数据列表
		/// </summary>
		public List<M_td_Links> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<M_td_Links> DataTableToList(DataTable dt)
		{
			List<M_td_Links> modelList = new List<M_td_Links>();
