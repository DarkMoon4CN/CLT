...
namespace ChuanglitouP2P.BLL
{
	...
	/// td_Ad
	/// </summary>
	public partial class B_td_Ad
	{
		private readonly D_td_Ad dal=new D_td_Ad();
		public B_td_Ad()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public M_td_Ad GetModelByCache(int Adid)
		{
			
			string CacheKey = "td_AdModel-" + Adid;
		...
		/// 获得数据列表
		/// </summary>
		public List<M_td_Ad> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<M_td_Ad> DataTableToList(DataTable dt)
		{
			List<M_td_Ad> modelList = new List<M_td_Ad>();
