window.onload=function(){
	...
	aBtn1.onclick=function(){
		...
		inner1.innerHTML='<span>投资金额<input type="text"><i>-</i><input type="text">元</span><span class="z_span">赠送现金百分比<input type="text">%</span><a style="margin-left: 19px;" href="javascriprt:void(0)" id="z_ap12"><img src="img/icon_04.png"></a>';
	...
	aBtn2.onclick=function(){
		...
		inner1.innerHTML='<span>投资金额<input type="text"><i>-</i><input type="text">元</span><span class="z_span">赠送现金百分比<input class="z_num" type="text">%</span><a href="javascriprt:void(0)" id="z_ap14"><img src="img/icon_04.png"></a>';
	...
	oBtn1.onclick=function(){
		...
		inner1.innerHTML='<span>投资金额<input type="text"><i>-</i><input type="text">元</span><span class="z_span">赠送现金百分比<input class="z_num" type="text">%</span><a href="javascriprt:void(0)" id="z_ap02"><img src="img/icon_04.png"></a>';
		inner1.style.marginBottom="11px";
		inner1.style.marginLeft="138px";
		inner1.className='zTab_li2';
	};
	...
	oBtn3.onclick=function(){
		...
		inner1.innerHTML='<span>投资金额<input type="text"><i>-</i><input type="text">元</span><span class="z_span">赠送抵扣券<input type="text">张，分别为<input type="text" class="z_41">元、<input type="text" class="z_41">元不等</span><a href="javascriprt:void(0)" class="z_ap04"><img src="img/icon_04.png"></a>';
	...
	oBtn6.onclick=function(){
		...
		inner1.innerHTML='<span>投资金额<input type="text"><i>-</i><input type="text">元</span><span class="z_span">赠送加息券百分比<input class="z_num" type="text">%</span><a id="z_ap_02" href="javascriprt:void(0)"><img src="img/icon_04.png"></a>';
		inner1.className="zTab_li2";
		inner1.style.paddingLeft="138px";
	...
	oBtn7.onclick=function(){
		...
		inner1.innerHTML='<span>投资金额<input type="text"><i>-</i><input type="text">元</span><span class="z_span">赠送加息券<input type="text">张，分别为<input type="text">%、<input type="text">%、<br><input type="text">%不等<a href="javascriprt:void(0)" id="z_ad_04"><img src="img/icon_04.png"></a></span>';
	...
	oBtn8.onclick=function(){
		...
		inner1.innerHTML='<span><input type="text">元抵扣券，投资金额<input type="text"><i>-</i><input type="text">元可用，过期时间<input type="text" class="z_time"></span><a id="z_ad_06" href="javascriprt:void(0)"><img src="img/icon_04.png"></a>';
		inner1.style.marginBottom="14px";
