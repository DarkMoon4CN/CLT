...
function choujiangAction() {
    ...
    $.post("/Topic/T20161212/LuckDrawAward", {}, function (result) { luckDrawAward(result); });
...
function GetRTime() {
    ...
    t = et - NowTime.setSeconds(NowTime.getSeconds() + 1);
    timeCot(t);
    if (t < 0) {
