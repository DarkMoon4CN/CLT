...
window.onload=function(){
	...
	oBtn1.onclick=function(){
		...
		inner1.innerHTML = '受邀好友投资金额<input type="text"  name="startAmt" id="startAmt"><i>-</i><input type="text" name="endAmt" id="endAmt">，邀请人获得现金为投资额的<input type="text" name="percent" id="percent">%<a href="javascript:void(0)" id="z_ap02"><img src="/Areas/Admin/img/icon_04.png"></a>';
	};
	...
	oBtn4.onclick=function(){
		...
		inner1.innerHTML='<span><input type="text">元抵扣券，投资金额<input type="text"><i>-</i><input type="text">元可用，过期时间<input type="text" class="z_time jcDate"></span><a href="javascriprt:void(0)" class="z_ap06"><img src="/Areas/Admin/img/icon_04.png"></a>';
    ...
    /*oBtn5.onclick=function(){
		...
		inner1.innerHTML='<span><input type="text">元抵扣券，投资金额<input type="text"><i>-</i><input type="text">元可用，过期时间<input type="text" class="z_time jcDate"></span><a href="javascriprt:void(0)" class="z_ap08"><img src="/Areas/Admin/img/icon_04.png" id="z_ap09"></a>';
	...
	oBtn6.onclick = function () {
		...
		inner1.innerHTML='<span><input type="text">元抵扣券，投资金额<input type="text"><i>-</i><input type="text">元可用，过期时间<input type="text" class="z_time jcDate"></span><a href="javascriprt:void(0)" class="z_ap16"><img src="/Areas/Admin/img/icon_04.png"></a>';
		inner1.style.marginBottom='28px';
		inner1.style.paddingLeft='138px';
	...
	oBtn7.onclick=function(){
		...
		inner1.innerHTML='<span><input type="text">元抵扣券，投资金额<input type="text"><i>-</i><input type="text">元可用，过期时间<input type="text" class="z_time jcDate"></span><a href="javascriprt:void(0)" class="z_ap18"><img src="/Areas/Admin/img/icon_04.png" id="z_ap09"></a>';
