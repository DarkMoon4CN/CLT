...
namespace ChuanglitouP2P.Controllers
{
    public class XiCaiChannelController : Controller
    {
        ...
        public ActionResult AutoRegisterLogin(string sign)
        {
            ...
            XiCaiHelper.loginIn log = new SigninController().loginIn;
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult PushTarget(string pids)
        {
            string res = xicai.PushP2PData(pids);
            return Content(res);
        }
        //    /// <summary>
        //    /// 推送标的编号数据方法
        ...
        //    /// <returns></returns>
        //    private string PushP2PData(string pid)
        //    {
        ...
        //                //Response.End();
        //                return Content("{\"code\":1001,\"msg\":\"缺少参数pid\"}");
        //            }
        ...
        //                //Response.End();
        //                return Content("{\"code\":1008,\"msg\":\"参数client_secret错误\"}");
        //            }
        //            Product product = new Product();
        //            int targetID = 0;
        //            if (!int.TryParse(pid, out targetID))
        //            {
        //                return Content(JsonConvert.SerializeObject(product, Formatting.Indented, timeFormat));
        //            }
        ...
        //            var investCount = ef.V_hx_Bid_records_borrowing_target.Where(p => p.targetid == targetID).Count();
        //            product = new Product()
        //            {
        ...
        //                inverst_mans = investCount,
        //                underlying_start = Convert.ToDateTime(target.start_time),
        //                link_website = "http://test.chuanglitou.com/register/index?channel=X1CUVA1H&type=1",
        ...
        //            if (CheckTimeOut(t)) { return Content("该操作已经失效，请重新操作"); }
        ...
        //                AddCache("TNZ0U5TH");
        //                string res = new RegisterController().Register("", password.Substring(password.Length - 8, 8), phone, name + phone.Substring(phone.Length - 4, 4), true).ToString();
        ...
        //                    return XiCaiLogin(phone, pid, display);
        //                }
        //                else
        //                {
        //                    return Content(registerRes.error);
        //                }
        //            }
        //            else//登录逻辑
        //            {
        ...
        //    private void AddCache(string channelCode)
        //    {
        ...
        //    /// <param name="pid"></param>
        //    /// <returns></returns>
        //    private ActionResult XiCaiLogin(string phone, string pid, string display)
        //    {
        //        var user = ef.hx_member_table.Where(c => c.mobile == phone).FirstOrDefault();
        //        string sourcePwd = DESEncrypt.Decrypt(user.password, ConfigurationManager.AppSettings["webp"].ToString());
        //        string res = new SigninController().loginIn(phone, sourcePwd, "", 1, true).ToString();
        //        registerBackData loginRes = JsonConvert.DeserializeObject<registerBackData>(res);
        //        if (loginRes.rs == "y")
        //        {
        //            return Redirect(loginRes.url + "invest_borrow_" + pid + ".html");
        //        }
        //        else
        //        {
        //            return Content(loginRes.error);
        //        }
        //    }
        //    public void InvestCallBack(int bidRecordID)
        //    {
        ...
        //    /// <returns></returns>
        //    [HttpGet]
        //    public ActionResult Tongji_User(string t, string token, string startdate, string enddate, int page, int pagesize)
        //    {
        //        try
        //        {
        ...
        //            if (CheckTimeOut(t))
        //            {
        //                return Content("{\"code\":1008,\"msg\":\"请求失效\"}");
        //            }
        //            if (string.IsNullOrEmpty(token))
        //            {
        //                return Content("{\"code\":1008,\"msg\":\"参数token错误\"}");
        //            }
        //            string localToken = EncryptHelper.GetMd5Str32(EncryptHelper.GetMd5Str32(t, "x") + _client_secret, "x");
        //            if (localToken != token)
        //            {
        //                return Content("{\"code\":1008,\"msg\":\"请求被篡改\"}");
        //            }
        ...
        //                           })
        //                           on item.registerid equals money.investor
        //                          select new
        //                          {
        ...
        //                              totalmoney = money.investMoney,
        //                              display = xicai.Display
        //                          };
        //            int totalCount = resData.Count();
        //            List<tj_user> res = (from item in resData.Skip((page - 1) * pagesize).Take(pagesize).ToList()
        //                                 select new tj_user
        //                                 {
        //                                     email = item.email,
        //                                     id = item.id,
        ...
        //                                 }).ToList();
        //            string r = string.Format("{\"list\":{0},\"total\":{1},\"code\":0}", JsonConvert.SerializeObject(res, Formatting.Indented, timeFormat), totalCount);
        //            return Content(r);
        //        }
        //        catch (Exception ex)
        //        {
        ...
        //    /// <returns></returns>
        //    [HttpGet]
        //    public ActionResult Tonji_Invest(string t, string token, string startdate, string enddate, int page, int pagesize)
        //    {
        //        try
        //        {
        //            if (CheckTimeOut(t))
        ...
        //            var res = (from item in resData.Skip((page - 1) * pagesize).Take(pagesize).ToList()
        //                       select new tj_data
        //                       {
        ...
        //        catch (Exception ex)
        //        {
        //            LogInfo.WriteLog("投资统计接口，异常消息：" + ex.Message + ",Trace:" + ex.StackTrace);
        //            return Content("操作异常，请稍后重试");
        //        }
        //    }
        //    /// <summary>
        ...
        //    {
        //        TimeSpan ts = new TimeSpan(long.Parse(t));
        //        TimeSpan nowTs = DateTime.Now - DateTime.Parse("1970-01-01");
        //        TimeSpan diff = nowTs - ts;
