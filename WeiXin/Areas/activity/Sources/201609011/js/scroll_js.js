...
$(function () {
        ...
        $('.pointer').rotate({
            ...
            callback: function () {
                if (shuy == "1") {
                    ...
                    $('.tc_01 dt').html(txt);
                    if (shuy = "0" || shuy == "2") {
                        $('a.chakan').prop("href", '/InterestRates/Index');
                        $('a.shiyong').prop("href", '/Home/Index');
                    }
                    if (shuy = "4" || shuy == "6" || shuy == "7") {
                        $('a.chakan').prop("href", '/Cash/CashCoupon')
                        $('a.shiyong').prop("href", '/Home/Index');
                    }
                    bRotate = !bRotate;
                }
    ...
    function choujiangAction() {
        ...
        //allFun.shortAjax("/activity/W20160901/LuckDrawAward", "{}", luckDrawAward);

        $.post("/activity/W201609011/LuckDrawAward", {}, function (result) { luckDrawAward(result); });

        console.log(item);
    }
    $(".zp_rotate").on("click", function () { choujiangAction(); });
